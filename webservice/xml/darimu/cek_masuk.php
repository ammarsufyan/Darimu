<?php
	...
	$nama_pengguna_atau_email_input = $_GET['nama_pengguna_atau_email'];
	$kata_sandi_input = $_GET['kata_sandi'];
	
	// execute query 
	$query = "SELECT * FROM tb_pengguna WHERE (nama_pengguna='$nama_pengguna_atau_email_input' OR alamat_email = '$nama_pengguna_atau_email_input') AND kata_sandi='$kata_sandi_input'";
